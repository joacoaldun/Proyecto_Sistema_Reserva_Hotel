...
void CrearMenu::integrantes()
{
    ...
    string integrantes[]= {"Lara Campos, Brian Esteban - Profesor","Gonzalez, Juan Agustín - Jefe de trabajos prácticos","Ávila Rotela, Catalina - Ayudante de trabajos prácticos","Noelia Elizabeth Afonso de Souza || Legajo: 27082","Joaquin Alduncin || Legajo: 25778","Pablo Gabriel Felice || Legajo: 26283"};
    string espacio="                                                      ";
    char salir;
    system("cls");
    cout<<endl<<endl;
    ...
    cout<<endl<<espacio<<"                           - ESTUDIANTES -"<<endl<<endl;
    rlutil::setColor(rlutil::WHITE);
